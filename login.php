...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form class="signup_form" action="connect.php" method="post" name="RegForm" onsubmit="return validated1()">
	...
	<div class="form-container sign-in-container">
		<form class="login_form" action="Employee.php" method="post" name="form" onsubmit="return validated()">
			<h1>Sign in</h1>
